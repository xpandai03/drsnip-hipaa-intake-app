...
export const REGISTRATION_SECTIONS: PdfSection[] = [
  ...
  {
    // C.2 (Phase 4B): all medical-history questions live under ONE header so a
    // doctor reads straight down the list instead of jumping between themed
    // sub-sections. Question order is Jeff's established Phase-3 order; PCP
    // leads the section as before. No question/answer/explanation removed.
